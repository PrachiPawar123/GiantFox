			...
			<div class="bill_total_wrap">
				<div class="bill_sec">
			        ...
			        <span>
			          ...
			          <?php echo $EDITDATA[0]->compony_name; ?><br>
			          <?php echo $EDITDATA[0]->address; ?> <br>
			          <?php echo $EDITDATA[0]->city; ?>  <?php echo $EDITDATA[0]->state; ?>  <?php echo $EDITDATA[0]->pincode; ?> <?php echo $EDITDATA[0]->country; ?>
			        </span>
				</div>
				...
				<div class="table_body">
					...
					<div class="row">						
						<div class="col col_des">
               				<img src="<?php echo base_url(); ?>media/uploads/product/<?php echo $data->thumb_img; ?>" alt="full-image" style="height: 125px">
						</div>
