...
.product {
    text-align: center;
         ...
         <div class="arrivals" style="padding-bottom: 0;">
            <div class="container-fluid">
               <div class="row">
                  <div class="col">
                     <div class="section_title_container text-center">
                        <!-- <div class="section_subtitle">only the best</div> -->
                        <div class="section_title">ALL ITEMS</div>
                     </div>
                  </div>
               </div>
               <div class="row products_container">
                  ...
                  <div class="col-lg-3 col-sm-6 product_col product-width mb-4">
                    ...
                    <?php } ?>
                        <div class="product_image">
                           ...
                           if($data->show_sale==1)
                              { ?>
                           <span class="sale-tag" style="position: relative;top: 27px;">SALE</span>
                        <?php } ?> -->
                  ...
                  <?php } } else { ?>
                     <div class="col-lg-12 text-center">
                        <img src="<?php echo base_url(); ?>media/admin/no-found.png" class="img-fluid">
                     </div>
                  <?php } ?>
