               ...
               <div class="row">
                  ...
                  <div class="col-lg-12">
                     <div class="review_form_container">
                        <div class="review_form_title">Register</div>
                        <div class="review_form_content" style="margin-top: 50px;">
                        <?php echo $this->session->flashdata('message') ?>

                           <form action="<?=base_url('User/registration') ?>" id="review_form" class="review_form" method="post">
                              <div class="d-flex flex-md-row flex-column align-items-start justify-content-between" style="flex-direction: column!important;justify-content: center !important;align-items: center !important;">
                                 <input type="text" class="review_form_input" placeholder="Username" required="required" name="username" style="margin-bottom: 10px;">

                                 <input type="number" class="review_form_input" placeholder="Mobile" required="required" name="mobile" style="margin-bottom: 10px;">
                        ...
                        <div style="text-align: center;padding-top: 11px;">
                           <a href="<?=base_url() ?>login" style="color:black;font-weight: 600;" class="register">Click To Login</a>
                        </div>
                     </div>
                  </div>
               </div>
