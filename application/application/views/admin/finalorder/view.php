                        ...
                        <div class="row align-items-center">
                           <div class="col-lg-8 d-flex align-items-center">
                              <div class="h-65px w-65px d-flex align-items-center justify-content-center position-relative">
                                 <img src="<?php echo base_url(); ?>media/uploads/product/<?php echo $product[0]->thumb_img; ?>" class="mw-100 mh-100" />
                              ...
                              <div class="ps-3 flex-1">
                                 ...
                                 <div class="text-dark text-opacity-50 small fw-bold">
                                    Size: <?php echo sizename($size_id); ?><br>
                                    Color: <?php echo colorname($color_id); ?>
                                 </div>
                              </div>
                           </div>
                           <div class="col-lg-2 m-0 ps-lg-3">
                              <?php echo number_format($product[0]->sale_price,2); ?> x <?php echo $order->quantity; ?>
                           </div>
                           <div class="col-lg-2 text-dark fw-bold m-0 text-end">
                              ₹ <?php echo number_format($order->quantity*$product[0]->sale_price,2); ?>
                           </div>
                        </div>
                        <hr class="my-4" />
