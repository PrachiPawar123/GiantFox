                     ...
                     <table class="table table-invoice">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <td><?php echo $i; ?></td>
                              <td >
                                 <img class="avatar is-squared" style="height: 75px;" alt="user-icon" src="<?php echo base_url(); ?>media/uploads/product/<?php echo $product[0]->thumb_img; ?>">
                              </td>
                              <td>
                                 <strong>Name:- </strong> <?php echo $product[0]->name; ?><br>
                                 <strong>Size:- </strong> <?php echo sizename($size_id); ?> 
                              </td>
                              <td><?php echo number_format($product[0]->sale_price,2); ?></td>
                              <td><?php echo $order->quantity; ?></td>
                              <td>₹ <?php echo number_format($order->quantity*$product[0]->sale_price,2); ?></td>
                           </tr>
