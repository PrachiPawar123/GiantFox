                        ...
                        <div class="card-body">
                           <div class="row">
                              ...
                              <div class="col-lg-6 mb-3">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">Shipping Apply</label>
                                    <select class="form-select" name="shipping">
                                       <option value="1"  <?php if($EDITDATA[0]->shipping==1)echo 'selected'; ?>>Yes</option>
                                       <option value="0" <?php if($EDITDATA[0]->shipping==0)echo 'selected'; ?>>No</option>
                                    </select>
                                 </div>
                              </div>
                              ...
                              <div class="col-lg-6 mb-3">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <select class="form-select" name="view_all">
                                       <option value="1"  <?php if($EDITDATA[0]->view_all==1)echo 'selected'; ?>>Show</option>
                                       <option value="0" <?php if($EDITDATA[0]->view_all==0)echo 'selected'; ?>>Hide</option>
                                    </select>
                                 </div>
                              </div>
                              <div class="col-lg-6 mb-4">
                              ...
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="other" value="<?php echo $EDITDATA[0]->other; ?>">
                                 </div>
                              </div>
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">Express Amount</label>
                                    <input type="text" class="form-control" name="express" value="<?php echo $EDITDATA[0]->express; ?>">
                                 </div>
                              </div>

                              <div class="col-lg-6 mb-3">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">COD Avaliable</label>
                                    <select class="form-select" name="cod_avali">
                                       <option value="1"  <?php if($EDITDATA[0]->cod_avali==1)echo 'selected'; ?>>Yes</option>
                                       <option value="2" <?php if($EDITDATA[0]->cod_avali==2)echo 'selected'; ?>>No</option>
                                    </select>
                                 </div>
                              </div>
                              ...
                              <div class="col-lg-6 mb-3">
                                 <div class="mb-lg-0 mb-3">
                                    <label class="form-label">ONLINE Avaliable</label>
                                    <select class="form-select" name="online_avali">
                                       <option value="1"  <?php if($EDITDATA[0]->online_avali==1)echo 'selected'; ?>>Yes</option>
                                       <option value="2" <?php if($EDITDATA[0]->online_avali==2)echo 'selected'; ?>>No</option>
                                    </select>
                                 </div>
                              </div>
