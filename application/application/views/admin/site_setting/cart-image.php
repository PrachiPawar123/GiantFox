            ...
            <div class="d-flex align-items-center mb-3">
               <div>
                  <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item active"><i class="fa fa-arrow-back"></i> Edit Cart Image</li>
                  </ol>
                  <h1 class="page-header mb-0">Edit Cart Image</h1>
               </div>
            </div>
                      ...
                      <div class="card border-0 mb-4">
                        ...
                        <div class="card-body">
                           <div class="row">
                              ...
                              <div class="col-lg-6 mb-4">
                                 <div class="mb-lg-0 mb-3 bg-light">
                                    <label class="form-label"style="width: 100%;text-align: center; position: relative;border: 1px solid aliceblue;"> Upload Empty Cart Image
                                        <img id="blah2" src="<?php echo base_url($upload_path); ?><?php echo $EDITDATA[0]->empty_img; ?>" class="sd" style="width: 100%; height: 100%; position: relative; top: -22px;">
                                        <input  type="hidden" class="form-control" name="oldempty_img" value="<?php echo $EDITDATA[0]->empty_img; ?>">
                                       <input style="display: none;" type="file" class="form-control" name="empty_img"  id="imgInp2">
                                    </label>
                                 </div>
                              </div>
