                                ...
                                $color = $this->crud->selectDataByMultipleWhere('all_images',array('p_id'=>$EDITDATA[0]->id,));
                                    foreach ($color as $key => $value) 
                                    {
                                       $color_name = $this->crud->selectDataByMultipleWhere('color',array('id'=>$value->color_id));
                                        ?>
                                 <li>
                                    <input type="radio" id="colorradio_<?=$color_name[0]->id ?>" name="product_color" class="regular_radio colorradio_<?=$color_name[0]->id ?>" <?php if($key==0)echo'checked'; ?> value="<?=$color_name[0]->id ?>">
...
$(document).on("click", ".close-cart-btn",(function(e) {
    ...
    function get_stock()
    {
        ...
        // $("#mobile_image_html").removeClass("owl-loaded owl-drag");
