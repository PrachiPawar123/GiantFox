<?php 
$term = $this->crud->fetchdatabyid('9','site_setting');
$checkoutimg = $this->crud->fetchdatabyid('16','site_setting');
                  ...
                  <div class="col">
                     <div class="home_container">
                        <div class="home_content">
                           <div class="home_title">Return & Refund</div>
               ...
               <div class="row">
                  <div class="col">
                     <div class="review_form_container">
                        <div class="review_form_title mb-4">Return & Refund</div>
                           <?=$term[0]->content ?>
                     </div>
                  </div>
               </div>
