            ...
            <div class="newsletter">
               <div class="row product_row">
                  <div class="col-lg-7">
                     ...
                     <div class="row mobile-none" id="desktop_image_html">
                     ...
                     <div class="row desktop-none">
                        ...
                        <div class="product-details owl-carousel owl-theme" id="mobile_image_html">
                  ...
                  <div class="col-lg-5">
                     <div class="product_content">
                        <div class="product_name"><?=$EDITDATA[0]->name ?><br>
                            <br><?php
                               $i=1;
                               while($i<=5) 
                               {
                                ...
                                <div class="product_size">
                                  <ul class="d-flex flex-row align-items-start justify-content-start">
                                    ...
                                    $f_color_id = 0;
                                        ...
                                        {
                                           if($key==0) $f_color_id = $value->color_id;

                                            $color_name = $this->crud->selectDataByMultipleWhere('color',array('id'=>$value->color_id));
                                            ?>
                                     <li>
                                        <input type="radio" id="colorradio_<?=$color_name[0]->id ?>" name="product_color" class="regular_radio colorradiobtn colorradio_<?=$color_name[0]->id ?>" <?php if($key==0)echo'checked'; ?> value="<?=$color_name[0]->id ?>">
                                        <label for="colorradio_<?=$color_name[0]->id ?>" style="background: <?=$color_name[0]->color_code ?>;"></label>
                                     </li>
                                 <?php  } ?>
                            ...
                            <div class="product_size_container" style="margin-top:0">
                               <div class="product_size">
                                <span style="margin-bottom: 10px;">Size</span>
                                  <ul class="d-flex flex-row align-items-start justify-content-start" id="size-ul">
                                     <?php
                                 ...
                                 <?php  } ?>
                                  ...
                                  <span class="not-found" style="display:none;"><span id="sold_sizename" style="margin-right: 5px;"></span> size is not avaliable</span>
                               </div>
                               ...
                               <div class="product_quantity_container quantity-btn">
                                  ...
                                  <br>
                                  <span id="stock-quantity" style="margin-right: 0;"></span> <span>Left</span>
                               </div>
                            </div>
                            ...
                            <a  class="btn btn-primary add-to-wishlist-btn mt-3" style="width:100%;border-radius: 9px;background-color: #000;border: 1px solid black;padding: 12px 0;color: white;cursor: pointer;">ADD TO WISHLIST</a>  

                            <a  class="btn btn-primary cart_button sold-out-btn-show" style="width:100%;border-radius: 9px;background-color: #000;border: 1px solid black;padding: 12px 0;color: white;cursor: pointer;">SOLD OUT</a>
                   ...
                   <tbody role="rowgroup">
                    <tr id="CartDrawer-Item-1" class="cart-item" role="row">
                        <td class="cart-item__media" role="cell" headers="CartDrawer-ColumnProductImage">
                            <img class="cart-item__image" src="<?=base_url() ?>media/uploads/product/<?=$EDITDATA[0]->thumb_img ?>" alt="" loading="lazy" width="150" height="150">
                        </td>
                        <td class="cart-item__details" role="cell" headers="CartDrawer-ColumnProduct">
                            <a href="#!" class="cart-item__name h4 break"><?=$EDITDATA[0]->name ?></a>
                            <div class="product-option">
                                RS. <?=$EDITDATA[0]->sale_price ?>
                            </div>
                            <div class="product-option">
...
$(document).on("click", ".close-cart-btn",(function(e) {
    ...
    function get_stock()
    {
        ...
        color_value = $('input[name="product_color"]:checked').val();
        // var size_val = $('input[name="product_radio"]:checked').val();
